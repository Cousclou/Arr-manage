...
SETTING_DEFAULTS: dict[str, str] = {
    ...
    "task_indexer_global_check_enabled": "false",
    "indexer_global_check_interval": "21600",
    "indexer_global_check_prowlarr": "true",
    "indexer_global_check_sonarr": "true",
    "indexer_global_check_radarr": "true",
...
SETTING_GROUPS: list[dict] = [
    ...
    },
    {
        ...
        "sections": [
            ...
            {
                "title": "Remédiation (indexeurs KO)",
                "description": "Détecte les indexeurs KO sur Sonarr/Radarr et ne teste que ceux-là (1 indexeur down = 1 test ciblé, jamais testall).",
                "fields": [
                    {"key": "task_indexer_health_enabled", "label": "Activer la remédiation", "type": "toggle"},
                    {"key": "indexer_health_interval", "label": "Intervalle remédiation (secondes)", "type": "number"},
            ...
            {
                "title": "Check global périodique",
                "description": "Teste tous les indexeurs en une fois (testall) sur Prowlarr et/ou Sonarr/Radarr, à intervalle séparé.",
                "fields": [
                    {"key": "task_indexer_global_check_enabled", "label": "Activer le check global", "type": "toggle"},
                    {"key": "indexer_global_check_interval", "label": "Intervalle check global (secondes)", "type": "number"},
                    {"key": "indexer_global_check_prowlarr", "label": "Testall Prowlarr", "type": "toggle"},
                    {"key": "indexer_global_check_sonarr", "label": "Testall Sonarr", "type": "toggle"},
                    {"key": "indexer_global_check_radarr", "label": "Testall Radarr", "type": "toggle"},
                ],
            },
        ],
    },
...
TASK_META = [
    ...
    {"name": "indexer_health", "label": "Remédiation indexeurs KO", "enabled_key": "task_indexer_health_enabled"},
    {"name": "indexer_global_check", "label": "Check global indexeurs", "enabled_key": "task_indexer_global_check_enabled"},
]
